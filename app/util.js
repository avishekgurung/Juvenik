...
function guestActivation(req, res) {
...
Util.processChat = processChat;
Util.getChatList = getChatList;
Util.getChatDetails = getChatDetails;
Util.makeChatList = makeChatList;
