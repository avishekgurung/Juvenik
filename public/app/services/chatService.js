...
/*
 angular.element(document.querySelector('html')).injector().get('DataGridService').CreateEmployee('A','G','12/33/2234','M',2344);

 angular.element(document.querySelector('html')).injector().get('ChatService').User

 Avishek 5932574b33fc2823fda378e6
 Bruce 59325d06f4826026a130682d
